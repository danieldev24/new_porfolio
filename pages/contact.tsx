                    ...
                    <Stack spacing={{ base: 10, md: 6 }} pt={{ base: 0, md: 40 }}>
                        ...
                        <Box alignSelf={'center'} textAlign='left'>
                            <HStack spacing={4} boxShadow='md' p='4' rounded='md' bg={boxBG}>
                                ...
                                <Stack spacing={0}>
                                    ...
                                    <Link href='mailto:hoangson24198@gmail.com' color='blue.500' fontWeight='medium'>hoangson24198@gmail.com</Link>
                                </Stack>
                            </HStack>
                        ...
                        <Box w='full' display={{ base: 'block', md: 'none' }}>
                            <ButtonGroup
                                ...
                                variant='ghost'>
                                <HStack spacing={2}>
                                    <Link isExternal href='https://www.instagram.com/hhoang_sson/'>
                                        <IconButton aria-label='Instagram' icon={<AiFillInstagram fontSize="1.5rem" />} />
                                    </Link>
                                    <Link isExternal href='https://www.linkedin.com/in/hoangson24198/'>
                                        <IconButton aria-label='Linkedin' icon={<AiFillLinkedin fontSize="1.5rem" />} />
                                    </Link>
                                    <Link isExternal href='https://join.skype.com/invite/e0CFqGdWwUII'>
                                        <IconButton aria-label='Twitter' icon={<AiFillSkype fontSize="1.5rem" />} />
                                    </Link>
                                    <Link isExternal href='https://github.com/danieldev24'>
