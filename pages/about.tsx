            ...
            <Flex
                ...
                <HStack spacing={4} align='flex-start' flexDirection={{ base: 'column', md: 'row' }}>
                    <Stack spacing={{ base: 2, md: 6 }}>
                        <CustomHeading headingText='Software Engineer' boxColor='yellow.100' chars={7.5} />

                        <Center display={{ base: 'block', md: 'none' }} pl={6}>
                            <CustomHeading headingText='Software Engineer' boxColor='pink.100' chars={8.5} />
                        </Center>
                        ...
                        <Stack spacing={{ base: 16, md: 6 }} direction={{ base: 'column-reverse', md: 'column' }}>
                            <Stack spacing={{ base: 4, md: 4 }} width={{ base: '100%', md: '70%' }}>
                                <Stack spacing={2}>
                                    ...
                                    <Text as='p'>
                                        ...
                                        from HCM Environment and Resources University, Ho Chi Minh City, in the year 2020 - with 3.04 GPA
                                    </Text>
                                </Stack>
                                <Stack spacing={2}>
                                    <Heading as='h3'
                            ...
                            <Box width={{ base: '100%', md: '60%' }} px={{ base: 16, md: 0 }}>
                                <SimpleGrid columns={{ base: 1, md: 2 }} spacing={2}>
                                    ...
                                    <HStack spacing={2}><HiOutlineMail size={'1.2em'} /><Text color={textColor} fontSize={{ base: 'sm' }}>hoangson24198@gmail.com</Text></HStack>
                                </SimpleGrid>
                            </Box>
                        </Stack>
                    </Stack>
